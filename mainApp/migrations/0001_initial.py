# Generated by Django 5.0.4 on 2024-04-04 06:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('raqam', models.PositiveSmallIntegerField(validators=[django.core.validators.MaxValueValidator(99)])),
                ('t_sana', models.DateField(blank=True, null=True)),
                ...
                ('possitsiya', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='mainApp.pozitsiya')),
            ],
        ),
    ]
